    ...
    <div className="min-h-screen bg-[#F8FAFC] text-slate-800 flex flex-col justify-center items-center p-4 sm:p-6">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-1">
          ...
          <h1 className="text-2xl font-extrabold text-[#0F172A] pt-3">Main Admin Portal</h1>
          <p className="text-slate-500 text-xs">Sign in to monitor college club governance</p>
        </div>
        ...
        <div className="bg-white border border-slate-200 p-6 sm:p-8 rounded-xl shadow-xs space-y-5">
          ...
          <div className="p-3 bg-slate-50 border border-slate-200 rounded-lg flex items-center justify-between text-xs">
            <div>
              ...
              <p className="text-slate-600 text-[11px]">Email: <span className="text-slate-900 font-mono font-medium">admin@college.edu</span></p>
              <p className="text-slate-600 text-[11px]">Pass: <span className="text-slate-900 font-mono font-medium">admin123</span> or <span className="text-slate-900 font-mono font-medium">superadmin123</span></p>
            </div>
            <button
              type="button"
              onClick={() => {
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-semibold text-slate-700 mb-1.5">Super Admin Email</label>
              <input
                type="email"
                required
                value={email}
            ...
            >
              {loading ? 'Authenticating...' : 'Sign in to Main Admin'}
            </button>
          </form>
