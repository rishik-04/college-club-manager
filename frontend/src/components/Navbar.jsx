...
export default function Navbar({ 
  ...
  const navItems = [
    ...
    { id: 'feed', label: 'Newsfeed', icon: Megaphone },
        ...
        <div className="flex items-center justify-between h-16">
              ...
              return (
                ...
                >
                  ...
                  {item.badge !== undefined && item.badge !== null && (
                    <span className="ml-0.5 px-1.5 py-0.2 text-[10px] font-bold rounded-full bg-rose-100 text-rose-600">
                      {item.badge}
                    </span>
                  )}
                  {item.highlight && (
          ...
          <div className="flex items-center gap-2.5">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-sky-700 bg-sky-50 border border-sky-200 rounded-full hover:bg-sky-100 transition shadow-sm"
